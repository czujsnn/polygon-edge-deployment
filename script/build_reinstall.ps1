...
kubens polygon-edge
#Delete PVC
kubectl delete deployment polygon-edge-node-1 -n polygon-edge
kubectl delete deployment polygon-edge-node-2 -n polygon-edge
kubectl delete deployment polygon-edge-node-3 -n polygon-edge
kubectl delete deployment polygon-edge-node-4 -n polygon-edge

kubectl delete pvc genesis-pvc -n polygon-edge
kubectl delete pvc node-pvc-1 -n polygon-edge
kubectl delete pvc node-pvc-2 -n polygon-edge
kubectl delete pvc node-pvc-3 -n polygon-edge
kubectl delete pvc node-pvc-4 -n polygon-edge
...
polygon-edge genesis --chain-id 19831608 --name polygon-edge-chain --consensus ibft --ibft-validator=0xd3a424bF4478Edf30933473977f162ec823349Ba --ibft-validator=0x08c762Fe32FAb7113bA482F73C5a72e46431eB92 --ibft-validator=0xBAf1891faA52455858714Fc1598B7785c9f752d3 --ibft-validator=0x05288955d8D6Ff0ea2283EC2241f97b2D9E35049 --bootnode=/ip4/172.17.0.120/tcp/1478/p2p/16Uiu2HAmFvwNpr2ZeDTLokncZwrMGSJLDGAQxvaAYYz9DkkpmABo --bootnode=/ip4/172.17.0.120/tcp/1478/p2p/16Uiu2HAm1VT5hke6gqAEaBVw48HeRFtG8RXwKAFpHTek57ZkC7eV
